...
export default function PropertyCard({ property }) {
  ...
  return (
    <div className="relative border p-4 rounded-lg shadow-lg bg-white transition hover:shadow-xl flex flex-col">
      {/* Property Image */}
      <Image src={property.images[0]} alt={property.title} width={500} height={300} className="w-full h-48 object-cover rounded-lg transition-transform transform hover:scale-105" />
